  ...
  return (
    <div className="space-y-[16px]">
      ...
      <section className="overflow-hidden rounded-[9px] border border-ink-200 bg-white shadow-card">
        ...
        <label className="mb-[18px] ml-[22px] flex items-center gap-3 text-[13px] text-ink-900">
          <span className="grid h-[15px] w-[15px] place-items-center rounded-[3px] bg-solar-600 text-white"><Check size={12} /></span>
