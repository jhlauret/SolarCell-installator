  ...
  return (
    ...
    >
      {benefits.map((item, index) => (
        ...
        >
          <div className="grid h-[62px] w-[62px] shrink-0 place-items-center rounded-full bg-[#E3F2E1] text-[#43A047]">
          ...
          <div className="pt-[3px]">
            ...
            <p className="mt-[8px] max-w-[205px] text-[14px] font-medium leading-[1.55] tracking-[-0.015em] text-[#405058]">
              {item.description}
            </p>
          </div>
        </article>
